      ...
      <aside className="w-64 flex-shrink-0 bg-slate-900/50 backdrop-blur-xl border-r border-slate-800/60 flex flex-col z-10">
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <div className="pt-4 mt-4 border-t border-slate-800/60">
            ...
            <SidebarLink href="/admin/integrations" icon="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1">
              Integrations
            </SidebarLink>
          </div>
        </nav>
